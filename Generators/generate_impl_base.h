...
class GenerateBase {
 public:
  ...
  OrtStatus CheckInputsImpl(const ParametersT& parameters,
                         const OrtValue* input_ids,
                         const OrtValue* vocab_mask,
                         const OrtValue* prefix_vocab_mask,
                         const OrtValue* attention_mask,
                         const OrtValue* presence_mask,
                         const OrtValue* decoder_input_ids) const {
 ...
 protected:
  ...
  const OrtSessionState& decoder_session_state_;
#endif
  ...
  OrtAllocator* temp_space_allocator_;
...
public:
  OrtValue* input_ids_value_;
  OrtValue* attn_mask_value_;
};
