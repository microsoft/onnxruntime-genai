# Normalize the target platform to x64 or arm64 (additional architectures can be
# added as needed) and expose it as `genai_target_platform`.
#
# Factored out of global_variables.cmake so that standalone SDK projects (e.g. the
# Java/AAR build) which consume the prebuilt core via find_package can reuse the
# exact same architecture normalization without pulling in the full core build.
if (MSVC)
