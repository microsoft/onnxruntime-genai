...
if(ORT_HOME)
  ...
  elseif(USE_CUDA)
    ...
    elseif(WIN32)
      if (CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64" OR CMAKE_GENERATOR_PLATFORM STREQUAL "arm64" OR CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64EC")
  ...
  elseif(USE_CUDA)
    if (WIN32 AND (CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64" OR CMAKE_GENERATOR_PLATFORM STREQUAL "arm64" OR CMAKE_GENERATOR_PLATFORM STREQUAL "ARM64EC"))
      set(ORT_HEADER_DIR ${ortlib_SOURCE_DIR}/build/native/include)
    else()
...
if(USE_DML)
  ...
  set(_DML_PREVIOUS_NUGET_PACKAGE_SOURCE "${NUGET_PACKAGE_SOURCE}")
  if(DML_NUGET_PACKAGE_SOURCE)
    set(NUGET_PACKAGE_SOURCE "${DML_NUGET_PACKAGE_SOURCE}")
  endif()
  install_nuget_package(
    ${DML_PACKAGE_NAME}
    ${DML_VERSION}
  ...
  install_nuget_package(
    ...
    ${D3D12_VERSION}
    D3D12_ROOT)
  set(NUGET_PACKAGE_SOURCE "${_DML_PREVIOUS_NUGET_PACKAGE_SOURCE}")
  unset(_DML_PREVIOUS_NUGET_PACKAGE_SOURCE)
