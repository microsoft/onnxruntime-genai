...
def test_get_output(test_data_path, relative_model_path):
    ...
    expected_sampled_logits_prompt = np.array([[[ 0.29694548,  0.00955007,  0.0430819,  0.10063869,  0.0437237 ],
    ...
    expected_sampled_logits_token_gen = np.array([[[ 0.03742531, -0.05752287,  0.14159015, 0.04210977, -0.1484456, ]],
