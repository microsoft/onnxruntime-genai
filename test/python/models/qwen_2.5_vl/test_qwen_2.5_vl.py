...
def test_parity(hf_model_name: str, cache_dir: str, onnx_model_path: str, use_gpu: bool, use_bf16: bool, use_fp16: bool):
    """
    ...
    inputs_embeds_prefill = torch.randn(
    ...
    inputs_embeds_decode = torch.randn(
