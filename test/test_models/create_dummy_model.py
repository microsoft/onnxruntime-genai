...
6) python create_dummy_model.py \
    --inputs "pixel_values; TensorProto.FLOAT; ['num_images', 'max_num_crops', 3, 'height', 'width']" "attention_mask; TensorProto.INT64; ['num_images', 'max_num_crops', 32, 32]" "image_sizes; TensorProto.INT64; ['num_images', 2]" \
    --outputs "image_features; TensorProto.FLOAT; ['num_image_tokens', 3072]" \
    --filename "dummy_vision.onnx"
7) python create_dummy_model.py \
    --inputs "audio_embeds; TensorProto.FLOAT; ['num_audios', 'num_frames', 80]" "audio_sizes; TensorProto.INT64; ['num_audios']" "audio_projection_mode; TensorProto.INT64; [1]" \
