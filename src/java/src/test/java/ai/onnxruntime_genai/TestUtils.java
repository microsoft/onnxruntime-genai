...
public class TestUtils {
  ...
  public static final String testModelPath() {
    ...
    URL url = GenAI.class.getResource("/hf-internal-testing/tiny-random-gpt2-fp32");
  ...
  public static final boolean setLocalNativeLibraryPath() {
    // set to <build output dir>/src/java/native-jni/ai/onnxruntime_genai/native/win-x64,
    // adjusting for your build output location and platform as needed
    String nativeJniBuildOutput =
        "build/Windows/Debug/src/java/native-jni/ai/onnxruntime_genai/native/win-x64";
    ...
    System.setProperty("onnxruntime_genai.native.path", fullPath.getPath());
    return true;
  }
}
