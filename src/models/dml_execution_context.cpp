...
DmlExecutionContext::DmlExecutionContext(ID3D12Device* d3d12Device, ID3D12CommandQueue* queue)
    : m_queue(std::make_shared<DmlCommandQueue>(queue)), m_dmlRecorder(d3d12Device, m_queue) {
}
