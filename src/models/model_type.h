...
struct ModelType {
  ...
  inline static bool IsVLM(const std::string& model_type) {
    ...
    static constexpr std::array<std::string_view, 10> VLM = {"fara", "gemma3", "mistral3", "muse_glimmer", "phi3v", "qwen2_5_vl", "qwen3_vl", "qwen3_5", "qwen3_5_moe", "videochat_flash_qwen"};
