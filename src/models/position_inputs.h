...
struct DefaultPositionInputs : PositionInputs {
 ...
 private:
  ...
  // This returns true when graph replay needs stable input addresses/shapes.
  // Both explicit graph capture and shared past/present buffers require static
  // mask allocation and special shape handling for optimization.
