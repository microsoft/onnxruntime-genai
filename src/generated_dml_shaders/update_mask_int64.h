...
; -------------------- ----- ------ -------- -------- ------- ------
; no parameters
; shader hash: be77e4fa3d62ef9a4934faefa461b85f
;
...
; <label>:17                                      ; preds = %10
  call void @dx.op.rawBufferStore.i32(i32 140, %dx.types.Handle %1, i32 %7, i32 0, i32 1, i32 0, i32 undef, i32 undef, i8 3, i32 8)  ; RawBufferStore(uav,index,elementOffset,value0,value1,value2,value3,mask,alignment)
  br label %40
...
; <label>:20                                      ; preds = %18
  %21 = call %dx.types.ResRet.i32 @dx.op.rawBufferLoad.i32(i32 139, %dx.types.Handle %2, i32 %12, i32 0, i8 3, i32 8)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
...
; <label>:29                                      ; preds = %20
  %30 = add i32 %12, -1
  %31 = call %dx.types.ResRet.i32 @dx.op.rawBufferLoad.i32(i32 139, %dx.types.Handle %2, i32 %30, i32 0, i8 3, i32 8)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
...
; <label>:39                                      ; preds = %29, %20, %18
  call void @dx.op.rawBufferStore.i32(i32 140, %dx.types.Handle %1, i32 %7, i32 0, i32 1, i32 0, i32 undef, i32 undef, i8 3, i32 8)  ; RawBufferStore(uav,index,elementOffset,value0,value1,value2,value3,mask,alignment)
  br label %40

; <label>:40                                      ; preds = %39, %29, %17, %0
  ret void
}
...
const unsigned char g_CSMain[] = {
  0x44, 0x58, 0x42, 0x43, 0xce, 0x67, 0x48, 0x6e, 0x47, 0xb1, 0xe0, 0xc2,
  0x67, 0xd4, 0xb5, 0x0d, 0x63, 0x3f, 0x66, 0x80, 0x01, 0x00, 0x00, 0x00,
  0xc0, 0x07, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0xbe, 0x77, 0xe4, 0xfa, 0x3d, 0x62, 0xef, 0x9a,
  0x49, 0x34, 0xfa, 0xef, 0xa4, 0x61, 0xb8, 0x5f, 0x44, 0x58, 0x49, 0x4c,
  0x9c, 0x06, 0x00, 0x00, 0x62, 0x00, 0x05, 0x00, 0xa7, 0x01, 0x00, 0x00,
  0x44, 0x58, 0x49, 0x4c, 0x02, 0x01, 0x00, 0x00, 0x10, 0x00, 0x00, 0x00,
  0x84, 0x06, 0x00, 0x00, 0x42, 0x43, 0xc0, 0xde, 0x21, 0x0c, 0x00, 0x00,
  0x9e, 0x01, 0x00, 0x00, 0x0b, 0x82, 0x20, 0x00, 0x02, 0x00, 0x00, 0x00,
  ...
  
};
