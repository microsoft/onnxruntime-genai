...
/** \brief Creates a snapshot of the accumulated speculative-decoding statistics.
 *  Values are zero for non-speculative models. The caller must destroy the returned object. */
OGA_EXPORT OgaResult* OGA_API_CALL OgaGenerator_GetSpeculativeStats(
...
/** \brief Gets a timing, rate, average, or speedup value from a statistics snapshot. */
