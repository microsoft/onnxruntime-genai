...
class QuarkModel(QuantizedModel):
    ...
    def repack_experts(self, experts):
        ...
        # make_moe_quark_preprocessing, so the native QMoE attrs (finalize_packed_experts) are not
        # used here.
    ...
    def combine_and_repack_split_experts_concat(self, experts):
        ...
        per_expert_scale is folded into fc2_scales later in make_moe_quark_preprocessing.
        """
    ...
    def _unpack_uint2_msb_first(self, packed):
