    ...
    parser.add_argument(
        ...
        help=textwrap.dedent("""\
            Key value pairs for various options. Currently supports:
                ...
                num_blocks = Fixed global paged KV-cache capacity. Must be a positive integer. Unset by default; when
                    unset, gpu_utilization_factor defaults to 0.6 and is used instead in genai_config.json. Required
                    for providers such as WebGPU that do not expose available device memory.
