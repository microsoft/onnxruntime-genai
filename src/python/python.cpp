...
PYBIND11_MODULE(onnxruntime_genai, m) {
  ...
  pybind11::class_<Generators::SamplingParams>(m, "SamplingParams")
      .def(pybind11::init<>())
      .def_readwrite("n", &Generators::SamplingParams::n)
      .def_readwrite("best_of", &Generators::SamplingParams::best_of)
      .def_readwrite("presence_penalty", &Generators::SamplingParams::presence_penalty)
      .def_readwrite("repetition_penalty", &Generators::SamplingParams::repetition_penalty)
      .def_readwrite("temperature", &Generators::SamplingParams::temperature)
      .def_readwrite("top_p", &Generators::SamplingParams::top_p)
      .def_readwrite("top_k", &Generators::SamplingParams::top_k)
      .def_readwrite("min_p", &Generators::SamplingParams::min_p)
      .def_readwrite("seed", &Generators::SamplingParams::seed)
      .def_readwrite("use_beam_search", &Generators::SamplingParams::use_beam_search)
      .def_readwrite("length_penalty", &Generators::SamplingParams::length_penalty)
      .def_readwrite("early_stopping", &Generators::SamplingParams::early_stopping)
      .def_readwrite("stop", &Generators::SamplingParams::stop)
      .def_readwrite("stop_token_ids", &Generators::SamplingParams::stop_token_ids)
      .def_readwrite("include_stop_str_in_output", &Generators::SamplingParams::include_stop_str_in_output)
      .def_readwrite("ignore_eos", &Generators::SamplingParams::ignore_eos)
      .def_readwrite("max_tokens", &Generators::SamplingParams::max_tokens)
      .def_readwrite("min_tokens", &Generators::SamplingParams::min_tokens)
      .def_readwrite("logprobs", &Generators::SamplingParams::logprobs)
      .def_readwrite("prompt_logprobs", &Generators::SamplingParams::prompt_logprobs)
      .def_readwrite("detokenize", &Generators::SamplingParams::detokenize)
      .def_readwrite("skip_special_tokens", &Generators::SamplingParams::skip_special_tokens)
      .def_readwrite("spaces_between_special_tokens", &Generators::SamplingParams::spaces_between_special_tokens);

  pybind11::class_<Generators::OgaEngine>(m, "Engine")
      .def(pybind11::init<const char*>())
      .def("add_request", &Generators::OgaEngine::AddRequest)
      .def("step", &Generators::OgaEngine::Step);
}
