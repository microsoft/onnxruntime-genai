 ...
 */
int TFM_API_CALL TfmGetAPIVersion(void);
 ...
 */
const char* TFM_API_CALL TfmGetLastErrorMessage(void);
 ...
 * \return Error code indicating the success or failure of the operation
 */
tfmError_t TFM_API_CALL TfmTokenize(
    const TfmTokenizer* tokenizer, const char* input[], size_t batch_size, TfmTokenId2DArray** output);
 ...
 * \return Error code indicating the success or failure of the operation
 */
tfmError_t TFM_API_CALL TfmDetokenize(
    const TfmTokenizer* tokenizer, const TfmTokenId2DArray* input, TfmStringArray** output);
 ...
 * \return Error code indicating the success or failure of the operation
 */
tfmError_t TFM_API_CALL TfmDetokenize1D(
    const TfmTokenizer* tokenizer, const tfmTokenId_t* input, size_t len, TfmStringArray** output);
 ...
 * \return Error code indicating the success or failure of the operation
 */
tfmError_t TFM_API_CALL TfmDetokenizeCached(
    const TfmTokenizer* tokenizer, TfmDetokenizerCache* cache, tfmTokenId_t next_id, const char** text_out);
 ...
 * \return Error code indicating the success or failure of the operation
 */
tfmError_t TFM_API_CALL TfmTokenId2DArrayGetItem(
    const TfmTokenId2DArray* token_id_2d_array, size_t index, const tfmTokenId_t** item, size_t* length);
