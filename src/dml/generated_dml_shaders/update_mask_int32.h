...
; -------------------- ----- ------ -------- -------- ------- ------
; no parameters
; shader hash: d6ec4349323cf0e3f43bc9a999568b5c
;
...
; <label>:19                                      ; preds = %15, %10
  ...
  call void @dx.op.rawBufferStore.i32(i32 140, %dx.types.Handle %1, i32 %7, i32 0, i32 %21, i32 undef, i32 undef, i32 undef, i8 1, i32 4)  ; RawBufferStore(uav,index,elementOffset,value0,value1,value2,value3,mask,alignment)
  br label %36
...
; <label>:24                                      ; preds = %22
  %25 = call %dx.types.ResRet.i32 @dx.op.rawBufferLoad.i32(i32 139, %dx.types.Handle %2, i32 %12, i32 0, i8 1, i32 4)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
...
; <label>:28                                      ; preds = %24
  %29 = add i32 %12, -1
  %30 = call %dx.types.ResRet.i32 @dx.op.rawBufferLoad.i32(i32 139, %dx.types.Handle %2, i32 %29, i32 0, i8 1, i32 4)  ; RawBufferLoad(srv,index,elementOffset,mask,alignment)
  %31 = extractvalue %dx.types.ResRet.i32 %30, 0
  %32 = icmp eq i32 %31, 1
  br label %33

; <label>:33                                      ; preds = %28, %24, %22
  %34 = phi i1 [ true, %24 ], [ true, %22 ], [ %32, %28 ]
  %35 = zext i1 %34 to i32
  call void @dx.op.rawBufferStore.i32(i32 140, %dx.types.Handle %1, i32 %7, i32 0, i32 %35, i32 undef, i32 undef, i32 undef, i8 1, i32 4)  ; RawBufferStore(uav,index,elementOffset,value0,value1,value2,value3,mask,alignment)
  br label %36
...
const unsigned char g_CSMain[] = {
  0x44, 0x58, 0x42, 0x43, 0x59, 0x01, 0xd5, 0x78, 0xd3, 0xd6, 0x0e, 0xd8,
  0x7e, 0x68, 0x4b, 0xe4, 0x34, 0x09, 0xdb, 0xaf, 0x01, 0x00, 0x00, 0x00,
  0xb0, 0x07, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x38, 0x00, 0x00, 0x00,
  ...
  0x00, 0x00, 0x00, 0x00, 0xd6, 0xec, 0x43, 0x49, 0x32, 0x3c, 0xf0, 0xe3,
  0xf4, 0x3b, 0xc9, 0xa9, 0x99, 0x56, 0x8b, 0x5c, 0x44, 0x58, 0x49, 0x4c,
  0x8c, 0x06, 0x00, 0x00, 0x62, 0x00, 0x05, 0x00, 0xa3, 0x01, 0x00, 0x00,
  ...
  0x9a, 0x49, 0x42, 0xc5, 0x18, 0x63, 0x0c, 0xba, 0x73, 0x04, 0xa0, 0x30,
  ...
  0x85, 0x51, 0x08, 0x85, 0x52, 0x80, 0x04, 0x14, 0x47, 0x00, 0x28, 0x17,
  ...
  0x61, 0x20, 0x00, 0x00, 0x48, 0x00, 0x00, 0x00, 0x13, 0x04, 0x49, 0x2c,
  0x10, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0x00, 0x34, 0x66, 0x00, 0x4a,
  0xae, 0xec, 0x0a, 0x53, 0xa0, 0x2c, 0x05, 0x4a, 0x37, 0xa0, 0x06, 0xc8,
  ...
  
};
