...
// Replays one compact transition series per descriptor. Descriptors already reside in device
// memory and may describe heterogeneous convolution and GDN state tensors.
