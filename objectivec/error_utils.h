...
#define OGA_OBJC_API_IMPL_CATCH_RETURNING_BOOL(error) \
  OGA_OBJC_API_IMPL_CATCH(error, NO)

#define OGA_OBJC_API_IMPL_CATCH_RETURNING_NULLABLE(error) \
  OGA_OBJC_API_IMPL_CATCH(error, nil)
